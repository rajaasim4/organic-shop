                ...
                <div className="pl-10  py-10">
                    <ul className="w-full h-full flex flex-col text-xl gap-y-6 ">
                        <li className=" font-semibold  w-11/12 pl-2 rounded-lg">
                            <div className="pb-2 flex items-center justify-between cursor-pointer " role="button" onClick={() => setShowProducts(!showProduct)}>
                                ...
                                <span className={`${showProduct ? "rotate-180" : "rotate-0"} duration-300`}>
                                    <IoIosArrowDown />
                                </span>
                            </div>
                            {/* {showProduct && */}
                            <ul className={`list-disc  font-normal text-base flex flex-col gap-y-3 duration-300 ${showProduct ? "h-[160px]" : "h-0 "} overflow-hidden `}>
                        ...
                        <li className="text-xl font-semibold  w-11/12 pl-2 rounded-lg">
                            <Link to={"/Dashboard/Users"} className="flex items-center gap-x-2 hover:text-white hover:bg-btn_bg duration-300 py-2 pl-1 rounded-lg">
