            ...
            <div className=" flex justify-between w-95 mx-auto items-center">
                <div className="flex items-center gap-x-7 ">
                    ...
                    <div className="flex items-center bg-white px-2 rounded-3xl pl-4 sm:hidden">
                        ...
                        <input type="text" className="outline-none pl-2 py-3 rounded-2xl text-gray-400" placeholder="Search...." />
                    </div>
...

                    {
                        ...
                        <div className="absolute top-14 z-50 -right-1/4  bg-white shadow-lg rounded-lg w-[300px] pb-3 px-2  xsm:-right-[134%] xsm:w-[270px] pt-1" >
                            ...
                            <ul className="h-full w-full  flex flex-col gap-y-3">
                                ...
                                <li className="cursor-pointer flex items-center gap-x-3 pl-2 hover:bg-gray-200 duration-300 rounded-lg" onClick={() => setShowloginDopdown(false)}>
                                    <span className="bg-primary_dark_green text-white grid place-items-center rounded-full text-2xl w-12 h-12 xsm:w-9 xsm:h-9 xsm:text-xl"><AiOutlineUser /></span>
                                    Edit Profile
                                </li>
                                <li className="cursor-pointer flex items-center gap-x-3 pl-2 hover:bg-gray-200 duration-300 rounded-lg" onClick={() => setShowloginDopdown(false)}>
                                    <span className="bg-primary_dark_green text-white grid place-items-center rounded-full text-2xl w-12 h-12 xsm:w-9 xsm:h-9 xsm:text-xl"><IoMailOutline /></span>
                                    Messages
                                </li>
