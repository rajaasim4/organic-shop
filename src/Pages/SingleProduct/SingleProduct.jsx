...
const SingleProduct = (props) => {
    ...
    // const { id, name, category, price, imgSrc, rating } = location.state;
                    ...
                    <div className="pb-28">
                        <div className="flex justify-between min-h-[400px] gap-x-5  ">
                            <div className="w-5/12 flex items-center justify-center rounded-lg border border-gray-200 shadow-xl">
                                <img src={imgSrc} className="w-9/12 h-full object-contain" alt="" />
                            </div>
                            <div className="w-1/2 p-5">
                                <h1 className="text-3xl font-light sm:text-3xl md:text-4xl xsm:text-2xl  my-8">{name}</h1>
                                ...
                                <div className="mt-2">
                                    <div className="flex  w-max pr-3 py-2 items-center flex-wrap">
                                        ...
                                        <button className="w-9 border h-9 border-gray-400 rounded-lg grid place-items-center text-xl" onClick={decreaseQuantity}>
                                            <BiMinus />
                                        </button>
                                        <div className="w-20  text-2xl font-semibold flex justify-center items-center">{itemquantity}</div>
                                        <button className="w-9 border h-9 border-gray-400 rounded-lg grid place-items-center text-xl" onClick={() => setItemQuantity((prev) => prev + 1)}>
                                            <BiPlus />
                                        </button>

                                        <button className="rounded-xl text-white w-32 h-12  mx-auto  bg-btn_bg cursor-pointer sm:mr-auto hover:bg-slate-800 duration-300 flex items-center justify-center ml-8" onClick={handleAddToCart}>
                                            Add To Cart
                                        </button>
                                    </div>
