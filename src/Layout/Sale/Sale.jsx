    ...
    return (
        <Helmet>
            <div className="flex gap-x-8">
                <div className="w-1/2 bg-sale_left_bg bg-cover flex items-end justify-end p-16 h-[400px] rounded-2xl">
                ...
                <div className="w-1/2 bg-sale_right_bg bg-cover flex items-end justify-start p-16 h-[400px] rounded-2xl">
